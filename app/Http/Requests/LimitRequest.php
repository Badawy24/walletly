...
class LimitRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $currentUser = $currentUserName ? \App\Models\User::where('user_name', $currentUserName)->first() : null;
        ...
        return [
            'user_name' => [
                ...
                'regex:/^[a-zA-Z0-9._-]+$/',
                'min:3',
                Rule::unique('users', 'user_name')->ignore($currentUser?->id),
            ],
    ...
    public function messages(): array
    {
        return [
            ...
            'user_name.unique' => 'This user name is already taken. Please choose another one.',
